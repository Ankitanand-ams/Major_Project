...
map.getView().fit([470172.824864, 2607267.858385, 519494.824864, 2637281.038032], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Harnessing Maxent and Web GIS for Urban Tree Species Habitat Prediction and Visualization in Asansol Municipal Corporation (West Bengal)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (164 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'A WEB GIS Application <br />     Developed by:- <br />      Ankit Anand <br /> <br /> <br />Contact:-<br />17ankitanand@gmail.com<br />8709603971<br />linkedin.com/in/ankit-anand-335117223';
            }
