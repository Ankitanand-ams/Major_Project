var size = 0;
var placement = 'point';
function categories_SoilType_40(feature, value, size, resolution, labelText,
...
case '5':
                    return [ new ol.style.Style({
        fill: new ol.style.Fill({color: 'rgba(174,160,10,1.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_SoilType_40 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_SoilType_40(feature, value, size, resolution, labelText,
